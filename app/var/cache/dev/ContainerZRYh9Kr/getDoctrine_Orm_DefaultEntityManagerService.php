...
$a->setNamespace('sf_orm_default_f2a0e187e67a20ec5e9c11d94e2dcd4e83e9239573d7462019bce0e0a86591f3');

$b = new \Doctrine\Common\Cache\ArrayCache();
$b->setNamespace('sf_orm_default_f2a0e187e67a20ec5e9c11d94e2dcd4e83e9239573d7462019bce0e0a86591f3');

$c = new \Doctrine\Common\Cache\ArrayCache();
$c->setNamespace('sf_orm_default_f2a0e187e67a20ec5e9c11d94e2dcd4e83e9239573d7462019bce0e0a86591f3');
...
$e->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\ServiceLocator(array('App\\Repository\\ProdutoRepository' => function () {
    return ($this->privates['App\Repository\ProdutoRepository'] ?? $this->load(__DIR__.'/getProdutoRepositoryService.php'));
}))));
