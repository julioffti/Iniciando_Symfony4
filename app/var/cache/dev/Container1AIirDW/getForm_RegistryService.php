...
return $this->privates['form.registry'] = new \Symfony\Component\Form\FormRegistry(array(0 => new \Symfony\Component\Form\Extension\DependencyInjection\DependencyInjectionExtension(new \Symfony\Component\DependencyInjection\ServiceLocator(array('App\\Form\\ProdutoType' => function () {
    return ($this->privates['App\Form\ProdutoType'] ?? $this->privates['App\Form\ProdutoType'] = new \App\Form\ProdutoType());
